...
export default function CallToAction() {
  return (
    <section className="py-20 px-6">
        ...
        <div>
              <h2 className="text-4xl font-bold text-maindarkgray font-roboto-slab mb-4">
            Celebrate Without Worry
          </h2>
          <h3 className="text-xl font-semibold font-roboto-slab text-maindarkgray mb-6">
            Book Verified Halwais for Your Next Event
          </h3>
          <p className="text-mainlightgray font-roboto-slab mb-8">
      ...
      <div className="grid md:grid-cols-2  gap-12 max-w-6xl mx-auto">
        ...
        <div className="text-center  md:text-left ">
          ...
          <p className="text-mainlightgray text-xl font-roboto-slab mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <a
              href="#"
              className="border border-red-600 text-red-600 px-6 py-3 rounded-xl hover:bg-red-50 transition"
            >
              Browse Halwais
            </a>
          </div>
